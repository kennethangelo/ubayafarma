...
<body class="u-body u-xl-mode">
    ...
    <section class="u-clearfix u-section-1" id="carousel_ef5d">
        <div class="u-clearfix u-sheet u-sheet-1">
            ...
            <di v class="u-clearfix u-gutter-20 u-layout-wrap u-layout-wrap-1">
                            ...
                            @foreach ($queryBuilder as $d)
                                <div
                                    ...
                                    <div class="u-container-layout u-container-layout-4">
                                        <img class="u-image u-image-3" src="{{ asset('img/'.$d->id.'.jpg') }}">
                                        <h4 class="u-align-center u-text u-text-custom-color-2 u-text-7">
                                            {{ $d->generic_name }}</h4>
                                        <p class="u-align-center u-text u-text-8">Rp{{ $d->price }}</p>
                                    </div>
                                </div>
                            @endforeach
                        </div>
